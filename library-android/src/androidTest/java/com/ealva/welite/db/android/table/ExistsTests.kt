...
class ExistsTests {
  ...
  @Test
  fun testSelectExists() = coroutineRule.runBlockingTest {
    Common.testSelectExists(appCtx, coroutineRule.testDispatcher)
  }

  @Test
  fun testSelectExistsAndOr() = coroutineRule.runBlockingTest {
    Common.testSelectExistsAndOr(appCtx, coroutineRule.testDispatcher)
  }

  @Test
  fun testSelectExistsOrExists() = coroutineRule.runBlockingTest {
