...
class CountTests {
  ...
  @Test
  fun testCountWithDistinctAndColumnsWithSameNameInDifferentTables() =
  ...
  @Test
  fun testCountWithDistinctAndColumnsWithSameNameInDifferentTablesWithAlias() =
    coroutineRule.runBlockingTest {
  ...
  @Test
  fun testCountWithGroupByQuery() = coroutineRule.runBlockingTest {
